...
import getRingBuffer from './RingBuffer.d.ts';
import getWamArrayRingBuffer from './WamArrayRingBuffer.d.ts';
import getWamEventRingBuffer from './WamEventRingBuffer.d.ts';
import getWamParameter from './WamParameter.d.ts';
import getWamParameterInfo from './WamParameterInfo.d.ts';
import getWamParameterInterpolator from './WamParameterInterpolator.d.ts';
import getWamProcessor from './WamProcessor.d.ts';
